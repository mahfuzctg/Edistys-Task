...
const tabs = [
  ...
  },
  {
    ...
    content: `Empower your organization to swiftly adapt to market demands using cutting-edge tools and methodologies.`,
    secondaryContent: `Our agile framework ensures seamless integration and high scalability for dynamic business growth.`,
    image:
  ...
  },
  {
    ...
    content: `Stay ahead of regulatory requirements with robust, compliance-ready solutions that ensure legal and ethical standards.`,
    secondaryContent: `We provide thorough documentation and auditing features for a smooth compliance process.`,
    image:
  ...
  },
  {
    ...
    content: `Protect your business and customer data with our state-of-the-art security features and protocols.`,
    secondaryContent: `With multi-layered encryption and real-time threat monitoring, your data is always safe.`,
    image:
...
const FutureTab: React.FC = () => {
  ...
  return (
    <div className="bg-white px-6 py-12">
      ...
      {/* Content Section */}
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 flex items-center gap-6">
        <div className="w-1/2">
          <h5 className="text-blue-500 text-sm font-medium">
